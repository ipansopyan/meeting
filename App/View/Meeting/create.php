    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          ...
          <form class='form-inline form-horizontal' method="post" action="?meeting=store_meeting" >
            <table>
              <tr>
                <td><label for="title">Ttitle</label></td>
                <td>&nbsp;&nbsp;</td>
                <td><input required name="title" type="text" class="form-control" id="title"></td>
              </tr>
              <tr>
                <td><label for="description">Description</label></td>
                <td>&nbsp;&nbsp;</td>
                <td><textarea required name="description" class='form-control'></textarea>
                </td>
              </tr>
              <tr>
                <td><label for="time">Time</label></td>
                <td>&nbsp;&nbsp;</td>
                <td><input required name="time" type="text" class="form-control" id="time"></td>
              </tr>
              <tr>
                <td><label for="place">Place</label></td>
                <td>&nbsp;&nbsp;</td>
                <td><input required name="place" type="text" class="form-control" id="place"></td>
              </tr>
              <tr>
